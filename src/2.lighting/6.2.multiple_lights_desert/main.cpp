...
int main(int argc, char** argv)
{
    ...
    learnopengl::PointLight pointLights[4];

    {
        ...
        for(auto& pointLight: pointLights)
        {
            ...
            pointLight.setPosition(pointLightPositions[index]);
    ...
    pointLights[0].setDiffuse(glm::vec3(1.f, 0.f, 0.f));
    pointLights[1].setDiffuse(glm::vec3(1.f, 1.f, 0.f));
    pointLights[2].setDiffuse(glm::vec3(1.f, 0.f, 0.f));
    pointLights[3].setDiffuse(glm::vec3(1.f, 1.f, 0.f));

    learnopengl::DirectionLight directionLight;
    directionLight.setAmbient(glm::vec3(0.01f));
    directionLight.setDiffuse(glm::vec3(0.7f, 0.42f, 0.26f));
    ...
    while(!glfwWindowShouldClose(window))
    {
...

        {
            ...
            {
                shaderProgram.setPointLight("pointLights[" + std::to_string(index) + "]", pointLight);
                ++index;
            }
        }
        ...
        shaderProgram.setSpotLight("spotLight", spotLight);
        ...
        for(const auto& pointLight: pointLights)
        {
            ...
            lightShaderProgram.setVec3("diffuseColor", pointLight.diffuse().r, pointLight.diffuse().g, pointLight.diffuse().b);

...
// VAO/VBO
std::tuple<unsigned int, unsigned int> createTriangleVAO(float (&vertices)[9])
{
...
int main()
{
    ...
    float vertices1[] = {0, -0.5, 0, 0.375, 0.5, 0, 0.75, -0.5, 0};
    float vertices2[] = {-0.75, -0.5, 0, -0.375, 0.5, 0, 0, -0.5, 0};

    const auto [VAO1, VBO1] = createTriangleVAO(vertices1);
    const auto [VAO2, VBO2] = createTriangleVAO(vertices2);
